                        ...
                        <div className="col-span-2">
                            <div>
                                ...
                                <p className="mt-4 text-gray-500 dark:text-gray-400">
                                    Sclippy Simulator is a free online tool that helps you learn the Mac shortcuts you need to know.
                                </p>
                            </div>
                        </div>
                            ...
                            <form className="w-full">
                                ...
                                >
                                    <input
                                        ...
                                        className="w-full border-none outline-none focus:outline-none focus:border-transparent focus:ring-transparent sm:text-sm dark:bg-gray-900 dark:text-white"
                                    />
                ...
                <div className="mt-8 border-t border-gray-100 pt-8 dark:border-gray-800">
                    <div className="sm:flex sm:justify-between">
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                            &copy; 2024. Sclippy All rights reserved.
                        </p>
